...
const MobileMenu = () => {
  ...
  return (
    <header className="md:hidden flex gap-6 bg-secondary py-4 px-6 md:px-12 relative">
      ...
      >
        <img
          src="/assets/Client-First - icons/icons8-menu.svg" // Image path from public folder
          alt="open-menu"
          className="w-6"
        />
      </button>
      <img
        src="/assets/Client-First - IMAGES/Logo.svg" // Image path from public folder
        alt="Finsweet-logo"
      />
      <Button
        variant={"white"}
      ...
      <nav
        ...
        ref={menuRef}
        className={`fixed z-[99] flex flex-col gap-6 items-center w-[320px] h-[100vh] bg-secondary top-0 left-0 px-8 py-8 shadow-black/60 shadow-md 
      ...
      >
        ...
        >
          <div>Close Menu</div>
          <img
            src="/assets/Client-First - icons/icons8-close.svg" // Image path from public folder
            alt="menu-close"
          />
        </Button>
        <Link
