...
const HeroSectionHome = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(to right, rgba(0, 0, 0, 0.65) 70%, rgba(0, 0, 0, 0.45)), url("/assets/Client-First - IMAGES/man-in-black-suit-wearing-eye-glasses-sitting-on-gray-sofa-using-macbook-3772622.svg")`,
      }}
    >
