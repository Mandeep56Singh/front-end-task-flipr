import authorPic from "../../assets/Client-First - IMAGES/man-in-yellow-button-up-shirt-wearing-black-framed-eyeglasses-7562313 (2).svg";
      ...
      <div className="flex flex-col gap-8 flex-1">
        ...
        <div className="flex justify-between">
          <div className="flex gap-2 ">
            <img src={authorPic} alt="author pic" className="size-14 " />
            <div>
              <div className="text-secondary font-semibold ">Jonathan</div>
              <div className="text-sm">Newyork,USA</div>
            </div>
          </div>
          <div className="flex gap-2">
