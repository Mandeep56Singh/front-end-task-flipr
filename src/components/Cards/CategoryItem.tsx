...
const CategoryItem: React.FC<props> = ({ title, icon }) => {
  return (
    <div
      ...
      className="flex sm:flex-col gap-2 p-4 border-2 border-gray-200 hover:bg-gradient-to-r hover:bg-primary items-center transition-all duration-300 ease-in-out rounded-lg"
    >
